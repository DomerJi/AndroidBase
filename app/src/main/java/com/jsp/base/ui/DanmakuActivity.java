...
import com.jsp.base.parser.BiliDanmukuParser;
...
//                    Log.d("DFM", "danmakuShown(): text=" + danmaku.text);
            ...
            mDanmakuView.setOnDanmakuClickListener(new IDanmakuView.OnDanmakuClickListener() {
                ...
                public boolean onDanmakuClick(IDanmakus danmakus) {
                    LogUtil.d("DFM", "onDanmakuClick: danmakus size:" + danmakus.size());
                    BaseDanmaku latest = danmakus.last();
                    if (null != latest) {
                        LogUtil.d("DFM", "onDanmakuClick: text of latest danmaku:" + latest.text);
                        return true;
                    }
                    return false;
                }
...
//                    mMediaController.setVisibility(View.VISIBLE);
        ...
        timer.schedule(new AsyncAddTask(),1000,5000);
